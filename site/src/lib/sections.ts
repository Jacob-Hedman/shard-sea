...
export const SECTIONS: Section[] = [
  ...
  // ---- World ----
  { kind: 'city_zone', icon: 'ti-building-arch', route: 'city-zones', label: 'City Districts', singular: 'District', group: 'World', blurb: 'The Districts a City is generated from — each with its Requirements, Size and Effects.', facets: [f('requires', 'Requires')], defaultSort: 'az', rulesPage: { slug: 'cities', label: 'How Cities work: stats, Tier & generating Districts' } },
  ...
  { kind: 'settlements', type: 'pages', pageKey: 'settlements', icon: 'ti-map-2', route: 'settlements', label: 'Cities & Outposts', singular: 'Settlement Rules', group: 'World', blurb: 'Cities and building outposts.', facets: [] },
